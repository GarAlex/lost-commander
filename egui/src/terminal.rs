...
use lost_commander_core::pty::PtySession;
...
///
/// The values are [`lost_commander_core::termview::xterm`]'s. They live there because the
...
fn palette(index: u8) -> Color32 {
    let (r, g, b) = lost_commander_core::termview::xterm(index);
